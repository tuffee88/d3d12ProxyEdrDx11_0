...
2. According to user reports this works *some cards* with Assassin's Creed Valhalla and Deth Stranding
  ...
  - Beware that you might experience crashes or graphicsl glitches - in that sorry, but that's not something that can be fixed in the scope of this project.
