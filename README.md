...
- Geforce: 940mx, 960m, 850m, 850mx, 670, 680, 690 750ti, 760, 770, 780, 780Ti, Tesla K40*, Quadro m1200
- Radeon: R9 280x, 270x, R7 370

2. According to user reports this works *for some cards* with Assassin's Creed Valhalla and Death Stranding and Far Cry 6 too
  ...
  - Beware that you might experience crashes or graphics glitches - sorry, but that's not something that can be fixed in the scope of this project. You may try to run this using Vulkan vkd3d-proton, which *might* fix the issues but usually has a performance penalty (see hint above).
     ...
     - Far Cry 6 has currently only been reported to work with a Radeon r7 370 4gb card
